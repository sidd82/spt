  ...
  return (
    <div className="footer-wrapper-spt">
      ...
      <div className="footer-bottom-spt">
        <div className="bottom-text-spt">
          savepertrip.com is the world leader in online travel & related
          services.
        </div>
        <div className="footer-copyright-spt">
          All Rights Reserved @svaepertrip.com. Designed & Developed by CoreCelo
        </div>
      </div>
    </div>
  );
